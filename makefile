...
pkgdatadir = $(datadir)/onedrive
pkgincludedir = $(includedir)/onedrive
pkglibdir = $(libdir)/onedrive
pkglibexecdir = $(libexecdir)/onedrive
...
am_onedrive_OBJECTS = src/onedrive-main.$(OBJEXT) \
	src/onedrive-filedata.$(OBJEXT) src/onedrive-http.$(OBJEXT) \
	src/onedrive-operator.$(OBJEXT)
onedrive_OBJECTS = $(am_onedrive_OBJECTS)
...
am__v_CCLD_1 = 
SOURCES = $(onedrive_SOURCES)
DIST_SOURCES = $(onedrive_SOURCES)
...
OBJEXT = o
PACKAGE = onedrive
PACKAGE_BUGREPORT = est.ling@qq.com
PACKAGE_NAME = onedrive
PACKAGE_STRING = onedrive 1.0
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/estling/c-c++/onedrive/onedrive
abs_srcdir = /home/estling/c-c++/onedrive/onedrive
abs_top_builddir = /home/estling/c-c++/onedrive/onedrive
abs_top_srcdir = /home/estling/c-c++/onedrive/onedrive
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/estling/c-c++/onedrive/onedrive/install-sh
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/onedrive-main.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/onedrive-filedata.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/onedrive-http.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/onedrive-operator.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)

onedrive$(EXEEXT): $(onedrive_OBJECTS) $(onedrive_DEPENDENCIES) $(EXTRA_onedrive_DEPENDENCIES) 
	@rm -f onedrive$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(onedrive_OBJECTS) $(onedrive_LDADD) $(LIBS)
...
include src/$(DEPDIR)/onedrive-filedata.Po
include src/$(DEPDIR)/onedrive-http.Po
include src/$(DEPDIR)/onedrive-main.Po
